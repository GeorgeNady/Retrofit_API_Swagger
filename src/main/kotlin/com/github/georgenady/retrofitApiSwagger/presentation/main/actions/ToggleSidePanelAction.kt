...
import com.github.georgenady.retrofitApiSwagger.presentation.main.MainToolWindow
...
class ToggleSidePanelAction : AnAction(
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val toolWindow = ToolWindowManager.getInstance(project).getToolWindow("RetrofitAPISwagger") ?: return
